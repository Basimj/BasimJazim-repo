 ...
 * 404 Section
 * 
 * slug: property-management-company/404-page
 * title: 404 Page
 * categories: property-management-company
 */

return array(
    'title'      =>__( '404 Page', 'property-management-company' ),
...
<!-- wp:search {"label":"Search","showLabel":false,"width":75,"widthUnit":"%","buttonText":"Search","align":"center","style":{"color":{"background":"#8d674d"}}} /--></main>
<!-- /wp:group -->',
);